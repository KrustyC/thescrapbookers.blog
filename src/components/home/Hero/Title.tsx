  ...
  return (
    <div className="-mt-24 lg:-mt-48 flex flex-col px-6 lg:px-16 xl:px-24 z-10 text-white/80">
      <h1
        ...
        className="text-8xl lg:text-9xl xl:text-10xl leading-[5.5rem] font-bold w-full uppercase"
      >
        {titlePart1} <br />
        {titlePart2}
      </h1>
      <div className="flex flex-col-reverse lg:flex-row lg:justify-between lg:items-start gap-4 lg:gap-0">
        <p
          style={poppins.style}
          className="lg:max-w-[600px] text-xl md:text-2xl lg:text-3xl font-light"
        >
          {subtitle}
        </p>
        <span
